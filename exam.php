...
// echo $_GET['time'];
			...
			{
        $dttime = $_GET['date']. " ". $_GET['time'];
				$sql="INSERT INTO exam (regno,subjectcode,datetime,status)VALUES ('$rsqueryst[regno]', '$s',  '".$dttime."',  'Enabled')";
        ...
        while($rs = mysqli_fetch_array($qresult))
            {
                ...
                {
                echo "<option value='$rs[subjectname]' selected>$rs[subjectname]</option>";
                }
                else
                {
