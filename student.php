...
?>
  <tr>
    ...
    <input name="name" type="text" id="name"  placeholder="Enter Name"  size="25"/></td> </th>
  </tr>
  
  <tr>
    <th scope="row">Registration No.</th>
    <td><input type="text" name="regno" id="regno"  placeholder="Enter Registration Number" size="25"/></td> </th>
  </tr></td>
  </tr>
  <tr>
    <th scope="row">New Password</th>
    <td><input type="password" name="npassword" id="npassword"  placeholder="Enter New Password  "  size="25"/></td> </th>
  </tr> </td>
  </tr>
  <tr>
    <th scope="row">Confirm password</th>
    <td><input type="password" name="cpassword" id="cpassword"  placeholder="Enter Confirm Password  " size="25"/></td> </th>
  </tr> </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <textarea name="address" id="address" cols="40" rows="5" placeholder="Enter Address" /></textarea></td>
  </tr>
  <tr>
    <th scope="row">Contact Number    </th>
    <td><label for="contact number"></label>
    <input type="text" name="contactnumber" id="contactnumber"  placeholder="Enter Contact Number"  size="25"/></td>
  </tr>
  <tr>
    <th scope="row">Status
