...
{ 
		...
		// 	{
			//echo "hello";
			$filename="1381766034_compass.png";
				$sql="INSERT INTO questions( subjectcode,  question, uploads, option1, option2, option3, option4, answer, descriptio, statu)
...
// ?>
 ...
 <td><textarea rows=2 cols=35 name="question" placeholder="Enter The Question"></textarea>
 </td>
 </tr>
...
//  }
 ...
 <td><textarea rows=2 cols=35 name="optiona" placeholder="Enter The Option"></textarea>
</td>
</tr>

 <tr>
 <th>Option B <font color='#FF0033'>*</font></th>
 <td><textarea rows=2 cols=35  name="optionb" placeholder="Enter The Option" ></textarea>
</td>
</tr>

 <tr>
 <th>Option C <font color='#FF0033'>*</font></th>
 <td><textarea rows=2 cols=35  name="optionc" placeholder="Enter The Option"></textarea>
</td>
</tr>

 <tr>
 <th>Option D <font color='#FF0033'>*</font></th>
 <td><textarea rows=2 cols=35  name="optiond" placeholder="Enter The Option"></textarea>
</td>
</tr>
...
<tr>
<th>Description</th>
<td><textarea rows=2 cols=35 name="description" placeholder="Enter The Description"></textarea>
</td>
</tr>
